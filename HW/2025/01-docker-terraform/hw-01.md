...
WITH one AS (
    ...
    WHERE trip_distance <= 1
      ...
      AND lpep_pickup_datetime < '2019-10-31'::timestamp + interval '1 day' -- < '2019-11-01'::timestamp for inclusive 31st
),
three AS (
    SELECT COUNT(index)
    FROM green_taxi_data
    WHERE trip_distance > 1
      AND trip_distance <= 3
      AND lpep_pickup_datetime >= '2019-10-01'::timestamp
      AND lpep_pickup_datetime < '2019-10-31'::timestamp + interval '1 day'
),
seven AS (
    SELECT COUNT(index)
    FROM green_taxi_data
